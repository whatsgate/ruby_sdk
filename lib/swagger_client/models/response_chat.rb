  ...
  class ResponseChat
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ResponseChat` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ResponseChat`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mute_expiration')
        self.mute_expiration = attributes[:'mute_expiration']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pinned == o.pinned &&
          is_muted == o.is_muted &&
          mute_expiration == o.mute_expiration &&
    ...
    def hash
      [id, name, is_group, is_read_only, unread_count, timestamp, pinned, is_muted, mute_expiration, group_metadata].hash
    end
